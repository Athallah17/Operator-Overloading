...
void persegiPanjang::output(){
    ...
    float width   = this->y_max - this->y_min; width   = abs (width);
        ...
        cout << "Nilai Minimal X        : " << this->x_min;    cout << endl;
        cout << "Nilai Maximal X        : " << this->x_max;    cout << endl;
        cout << "Nilai Minimal Y        : " << this->y_min;  cout << endl;
        cout << "Nilai Maximal X        : " << this->y_max;    cout << endl;
}
...
persegiPanjang persegiPanjang::operator-(persegiPanjang const &new_var){ //Pengurangan
    ...
    if (*this == new_var){
        ...
        cout << "Kedua Persegi Tidak Saling Beririsan Pada Semua Sisi" << endl;
    }
    return temp;
}
...
float persegiPanjang::operator[](int nilai){
    switch (nilai){
    case 1:
        return this->x_min;
        break;
